      ...
      return {
        ...
        panel_center_reasoning: {
          steps: [
            ...
            { id: 3, text: "Merchant Category: Cryptocurrency (High Risk)", status: "complete", result: "warning" },
            { id: 4, text: "Amount: €4,999 - Just below reporting threshold", status: "complete", result: "warning" },
            { id: 5, text: "⚠️ UNUSUAL PATTERN DETECTED", status: "complete", result: "warning" },
            { id: 6, text: "Merchant Location: Offshore jurisdiction", status: "complete", result: "warning" },
            { id: 7, text: "Entry Mode: Manual entry (no card verification)", status: "complete", result: "warning" },
            { id: 8, text: "Customer History: No prior crypto purchases", status: "complete", result: "warning" },
            { id: 9, text: "Risk Score Calculation: 65/100", status: "complete", result: "warning" },
            { id: 10, text: "VERDICT: HOLD FOR IDENTITY VERIFICATION", status: "complete", result: "warning" },
          ],
          risk_score: 65,
          verdict_color: "yellow",
        },
        panel_right_mobile: {
          view_type: "IDENTITY_VERIFICATION_VIEW",
          title: "Verify Your Identity",
          description: "This transaction requires additional verification. Please confirm your identity to proceed.",
          main_action: { label: "Verify Identity", type: "verify" },
          upsell_block: {
